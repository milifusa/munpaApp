...
const MilestonesScreen: React.FC = () => {
  ...
  const handleChildChange = async (child: Child) => {
    ...
    analyticsService.logEvent('milestones_child_changed', { child_id: child.id });
  };
            ...
            <View style={styles.contentContainer}>
              ...
              <View style={styles.comingSoonCard}>
                <View style={styles.comingSoonIcon}>
                  <Ionicons name="trophy" size={64} color={MUNPA_PINK} />
                </View>
                <Text style={styles.comingSoonTitle}>
                  ¡Hitos del Desarrollo en camino!
                </Text>
                <Text style={styles.comingSoonText}>
                  Estamos trabajando en esta funcionalidad para ayudarte a seguir y celebrar cada logro importante en el desarrollo de {selectedChild.name}.
                </Text>
                ...
                <View style={styles.featuresList}>
                  <View style={styles.featureItem}>
                    <Ionicons name="checkmark-circle" size={20} color={MUNPA_PINK} />
                    <Text style={styles.featureText}>Registrar hitos del desarrollo</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <Ionicons name="checkmark-circle" size={20} color={MUNPA_PINK} />
                    <Text style={styles.featureText}>Ver hitos esperados por edad</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <Ionicons name="checkmark-circle" size={20} color={MUNPA_PINK} />
                    <Text style={styles.featureText}>Agregar fotos y videos</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <Ionicons name="checkmark-circle" size={20} color={MUNPA_PINK} />
                    <Text style={styles.featureText}>Compartir logros con la familia</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <Ionicons name="checkmark-circle" size={20} color={MUNPA_PINK} />
                    <Text style={styles.featureText}>Recibir guías de estimulación</Text>
                  </View>
                </View>
              </View>
            </View>
